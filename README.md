...
### Very Small Bio
> Prof. Carlos Eduardo Pantoja is an associate professor and researcher at the Federal Center for Technological Education of Rio de Janeiro (CEFET/RJ) and he is a permanent professor from the Master's Program of Computing Teaching (PROFCOMP/UFRJ). He holds PhD in Computer Science from the Fluminense Federal University (UFF). He is a Senior Member of Institute of Electrical and Electronics Engineers (IEEE) and affiliated with the IEEE Industrial Electronics Society (IES), Chair of the Joint Chapter – IAS / PELS / IES from IEEE Rio de Janeiro Section, IEEE IES Hubs & Nodes Rio de Janeiro Coordinator, member of the Brazilian Computer Society (SBC), the Portuguese Artificial Intelligence Society (APPIA), and is the head of the Cognitive Hardware on Networks Research Group (CHON) of DGP/CNPq. He is currently Editor-in-Chief of the SBC's Electronic Journal Of Undergraduate Research On Computing (REIC). He works in `Artificial Intelligence`, more specifically in `Multi-agent Systems` and `Software Engineering` focusing in embedded systems.
